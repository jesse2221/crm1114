...
<script type="text/javascript">
						...
						*/
						...
						/*
							注意：
								...
								虽然jQuery对象没有为我们提供reset方法，但是原生js为我们提供了resetf方法
								所以我们要将jQuery对象转为原生的dom对象
	...
	/*
		...
		我们都在哪些情况下，需要调用pageList方法（什么情况下需要刷新一下市场活动）
		（1）点击左侧菜单的“市场活动”超链接，需要刷新市场活动列表，调用pageLiST方法
		（2）添加，修改，删除后，需要刷新市场活动列表，调用pageList方法
		（3）点击查询按钮的时候，需要刷新市场活动列表，调用pageList方法
		（4）点击分页组件的时候，调用pageList方法

		以上为pageList方法制定了六个入口，也就是说，在以上六个操作执行完毕后，我们必须要调用pageList方法，刷新市场活动信息列表。
	 */
							...
							<div class="col-sm-10" style="width: 81%;">
								<%--
									关于文本域textarea:
										...
										(2)textarea虽然是以标签对的形式来呈现的，但是它也是属于表单元素的范畴
